...
**Automated Deployment**: The app is automatically deployed to Google Cloud App Engine via GitHub Actions whenever changes are pushed to the `master` branch. See [DEPLOYMENT.md](DEPLOYMENT.md) for details on the deployment configuration.
